...
function InstagramIcon() {
  return (
    <svg style={{ width: 'clamp(32px, 8.2rem, 44px)', height: 'clamp(32px, 8.2rem, 44px)' }} viewBox="0 0 24 24" fill="white">
...
export default function QuickActions() {
  ...
  const openInstagram = () => setShowInstagram(true);
    ...
    },
    {
      ...
      icon: (
        <span
          ...
          style={{
            fontSize: 'clamp(32px, 8.2rem, 44px)',
